  ...
  <div class="offers__cards">
    ...
    <div class="offers__card">
      <div class="offers__card-img">
        <img class="offers__card-img--img" src="./img/Home/luxury-room-home.jpg" alt="">
      </div>
      <div class="offers__card-info">
        <div class="offers__prices">
          <div>
            <span class="text__price--small text--gold offers__price-old">$500</span><span class="offers__price-night text__price--night text--gold">/Night</span>
          </div>
        ...
        <div class="offers__amenities-container">
          <ul class="offers__amenities text__amenities text--gray">
            <li class="offers__feature">
              <img src="./img/RoomDetails/conditioner.svg" alt="ac-icon" class="offers__feature-img" />
              <p class="">Air conditioner</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/breakfast.svg" alt="breakfast-icon" class="offers__feature-img" />
              <p class="">Breakfast</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/cleaning.svg" alt="cleaning-icon" class="offers__feature-img" />
              <p class="">Cleaning</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/grocery.svg" alt="grocery-icon" class="offers__feature-img" />
              <p class="">Grocery</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/shop.svg" alt="shop-icon" class="offers__feature-img" />
              <p class="">Shop near</p>
            </li>
          </ul>
          <ul class="offers__amenities text__amenities text--gray">
            <li class="offers__feature">
              <img src="./img/RoomDetails/wifi.svg" alt="wifi-icon" class="offers__feature-img" />
              <p class="">High speed WiFi</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/kitchen.svg" alt="kitchen-icon" class="offers__feature-img" />
              <p class="">Kitchen</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/shower.svg" alt="shower-icon" class="offers__feature-img" />
              <p class="">Shower</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/singlebed.svg" alt="bed-icon" class="offers__feature-img" />
              <p class="">Single bed</p>
            </li>
            <li class="offers__feature">
              <img src="./img/RoomDetails/towel.svg" alt="towels-icon" class="offers__feature-img" />
              <p class="">Towels</p>
            </li>
          </ul>
        </div>
...
<section class="popular-rooms">
  <div class="popular-rooms-container">
    ...
    <div class="swiper swiper__popular-rooms ">
      <div class="swiper-wrapper swiper-wrapper__popular">
        @foreach ($rooms as $index => $room)
        @if($index <3) <div class="swiper-slide rooms__slide">
    ...
    <div class="room-card__buttons room-card__button--home">
      <button class="room-card__button button button--room-card popular-rooms__button-prev"><img src="./img/Home/Vector.svg" alt="arrow-icon" /></button>
      <button class="room-card__button button button--room-card button--golden popular-rooms__button-next"><img src="./img/Home/arrow-right.svg" alt="arrow-icon" /></button>
    </div>
  </div>
  </div>
</section>
