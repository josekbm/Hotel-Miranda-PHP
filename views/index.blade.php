  ...
  <div class="intro__availability">
    <div class="intro__calendar">
      <div class="intro__calendar-item">
        ...
        <input class="intro__calendar-input" type="date" placeholder="24th march 2020" />
      </div>
      <div class="intro__calendar-item">
        <label class="text--light text__label">Departure Date</label>
        <input class="intro__calendar-input" type="date" placeholder="30th march 2020" />
      </div>
    </div>
  ...
  <div class="about-us__cards">
    <div class="about-us__card--team">
      ...
      <div class="about-us__card--text">
        <img class="about-us__card--teamicon" src="./img/Home/teamicon.png" alt="equipo icono">
        <img class="about-us__card--teamback" src="./img/Home/teambackground.png" alt="equipo background">
    ...
    <div class="about-us__card--luxury">
      ...
      <div class="about-us__card--text about-us__card-text--dark">
        <img class="about-us__card--teamicon" src="./img/Home/luxury-room.png" alt="equipo icono">
  ...
  <div class="swiper swiper__core-features">
    <div class="swiper-wrapper core-features__slider core-features__slider">
      <div class="swiper-slide core-features__slide core-features__slide">
        <img class="core-features_number-icon core-features_number-icon" src="./img/Home/01.svg" alt="" />
        <div class="core-features__slide-info">
          <img class="core-features__icon" src="./img/Home/rating.svg" alt="" />
      ...
      <div class="swiper-slide core-features__slide core-features__slide">
        <img class="core-features_number-icon core-features_number-icon" src="./img/Home/02.svg" alt="" />
        <div class="core-features__slide-info">
          <img class="core-features__icon" src="./img/Home/hours.svg" alt="" />
      ...
      <div class="swiper-slide core-features__slide core-features__slide">
        <img class="core-features_number-icon core-features_number-icon" src="./img/Home/03.svg" alt="" />
        <div class="core-features__slide-info">
          <img class="core-features__icon" src="./img/Home/location.svg" alt="" />
          <h4 class="text__subtitle core-features__slide-title text--dark">
            Best Locations
          </h4>
          <p class="text__paragraph text--gray">
      ...
      <div class="swiper-slide core-features__slide core-features__slide">
        <img class="core-features_number-icon core-features_number-icon" src="./img/Home/04.svg" alt="" />
        <div class="core-features__slide-info">
          <img class="core-features__icon" src="./img/Home/cancelation.svg" alt="" />
          <h4 class="text__subtitle core-features__slide-title text--dark">
            Free Cancellation
          </h4>
          <p class="text__paragraph text--gray">
      ...
      <div class="swiper-slide core-features__slide core-features__slide">
        <img class="core-features_number-icon core-features_number-icon" src="./img/Home/05.svg" alt="" />
        <div class="core-features__slide-info">
          <img class="core-features__icon" src="./img/Home/payment.svg" alt="" />
          <h4 class="text__subtitle core-features__slide-title text--dark">
            Payment Options
          </h4>
          <p class="text__paragraph text--gray">
      ...
      <div class="swiper-slide core-features__slide core-features__slide">
        <img class="core-features_number-icon core-features_number-icon" src="./img/Home/06.svg" alt="" />
        <div class="core-features__slide-info">
          <img class="core-features__icon" src="./img/Home/offers.svg" alt="" />
          <h4 class="text__subtitle core-features__slide-title text--dark">
            Special Offers
          </h4>
          <p class="text__paragraph text--gray">
...
<section class="logros">
  <div class="logros__container">
    <div class="logros__card">
      <img class="logros__card-img" src="./img/Home/cohete.svg" alt="rocket" />
      <img class="logros__card-info" src="./img/Home/84.svg" alt="projects" />
    </div>
    <div class="logros__card">
      <img class="logros__card-img" src="./img/Home/plantilla.svg" alt="people" />
      <img class="logros__card-info" src="./img/Home/100M.svg" alt="backers" />
    </div>
    <div class="logros__card">
      <img class="logros__card-img" src="./img/Home/categorias.svg" alt="invest" />
      <img class="logros__card-info" src="./img/Home/02k.svg" alt="categories served" />
    </div>
    <div class="logros__card">
      <img class="logros__card-img" src="./img/Home/idea.svg" alt="book" />
      <img class="logros__card-info" src="./img/Home/100M2.svg" alt="raised funds" />
    </div>
  </div>
</section>
@endsection